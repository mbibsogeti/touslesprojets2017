...
function buttonClicked() {
	...
	if ((n > 50) || (n < 1)) {
		...
		mess.value = ""
		mess.value = "Demande envoyée, il"
				+ ((n > 1) ? " y aura " + n
						+ " voyageur(s) pour votre demande. "
						: " n'y aura que vous pour ce voyage. ")
	...
	mess.value += ". Temps de trajet total : " + parseInt(tempsTotal / 60)
			+ " heures et " + tempsTotal % 60 + " mins";
	var opt1 = new getOptions();
	console.log(opt1.Options(nbT.value))
	mess.value += opt1.Options(nbT.value);
